...
class Loss(dent.losses.baseloss.BaseLoss):
    ...
    def __call__(self, data, reconstructions, stats_qzx, is_train, groupfier, **kwargs):   
        ...
        hessian_loss, commute_loss = groupfier.group_loss()
        log_data['hessian_loss'] = hessian_loss.item()
        log_data['commute_loss'] = commute_loss.item()

        loss = rec_loss + self.beta * kl_loss + commute_loss

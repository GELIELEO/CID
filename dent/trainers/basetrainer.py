...
from tools.monitor.gradient_hook import collect_gradients
...
class BaseTrainer():
    ...
    def __call__(self, data_loader, epochs=10, iterations=-1, checkpoint_every=10, checkpoint_first=0, printlevel=1):
        ...
        for epoch in range(self.start_epoch, epochs):
            ...
            if checkpoint_every>=0 and ((epoch + 1) % checkpoint_every == 0 or epoch < checkpoint_first):
    ...
    def initialize_from_checkpoint(self, chkpt_data, uid=None, restore_hyperparams=False):

...
import dent.models.encoder.twoview_masked_encoder
import dent.models.decoder.montero_small

from dent.models.utils.self_attention import SelfAttention
...
class Model(nn.Module):
    ...
    def __init__(self, img_size, latent_dim, **kwargs):
        ...
        self.dist_nparams = 2
        self.encoder = dent.models.encoder.twoview_masked_encoder.Encoder(
        ...
        # self.attention = SelfAttention(1,1)
    ...
    def forward(self, x):
        ...
        # samples_qzx, att = self.attention(samples_qzx.unsqueeze(-1))
        # samples_qzx = samples_qzx.squeeze(-1)

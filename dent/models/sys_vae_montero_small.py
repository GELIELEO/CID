...
import dent.models.encoder.sys_montero_small
...
class Model(nn.Module):
    ...
    def __init__(self, img_size, latent_dim, **kwargs):
        ...
        self.dist_nparams = 2
        self.encoder = dent.models.encoder.sys_montero_small.Encoder(

...
COLOUR_WHITE = 1
DATASETS = [
    'mnist', 'fashionmnist', 'dsprites', 'celeba', 'chairs', 'shapes3d', 'mpi3d', 'mpi3d_real', 'mpi3d_real_complex', 'cars3d', 'smallnorb', 'flow', 'pendulum'
]
...
def get_dataset(dataset):
    ...
    if dataset == 'flow':
        import datasets.flow
        return datasets.flow.Flow
    if dataset == 'pendulum':
        import datasets.pendulum
        return datasets.pendulum.Pendulum
